    ...
    <div className={styles.dock}>
      <form className={styles.row} onSubmit={e => { e.preventDefault(); submit(); }}>
        ...
        <div className={styles.modelPill}>
          {/* Icon hidden on mobile via .modelIcon class */}
          <svg className={styles.modelIcon} width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: 'var(--rose)', flexShrink: 0 }}>
